export const tr: Record<string, string> = {
  ...
  "h ago": "s önce",
  "d ago": "g önce",
  "Approve Appeal": "İtirazı Onayla",
  "Deny Appeal": "İtirazı Reddet",
  "Admin Note (reason for decision)": "Yönetici Notu (karar sebebi)",
  "Enter reason for denial...": "Reddetme sebebini girin...",
  "Enter note about resolution...": "Çözüm hakkında not girin...",
  ...
  "Resolution Reason": "Çözüm Sebebi",
};
